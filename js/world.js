var world = new function() {
	...
	this.init3d = function (p, canvas) {
		...
		plane =  new THREE.Mesh(new THREE.PlaneBufferGeometry(2, 2,8,8), new THREE.MeshBasicMaterial({color: 0xffffff,
	...
	this.buildObject = function (contour, steiner, arrayDistance, triangles) {
		...
		geometry.scale(scale_y, -scale_y, scale_y);
	        var plane2 = new THREE.Mesh(new THREE.PlaneBufferGeometry(width_scene*this.canvas3d.width/this.canvas3d.height, this.canvas3d.width/this.canvas3d.height), new THREE.MeshBasicMaterial({color: 0xff0000,
